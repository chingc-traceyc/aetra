...
export default function Header() {
  return (
    <nav className="flex-no-wrap relative flex w-full items-center justify-between bg-neutral py-2 lg:flex-wrap lg:justify-start lg:py-4">
      <div className="flex w-full flex-wrap items-center justify-between px-3">
        ...
        {/* <div className="flex flex-col-center items-center text-neutral-900 justify-center"> */}
        <div className="flex flex-wrap items-center px-3">
          <h1 className="text-lg text-neutral-200 font-bold">AETRA</h1>
        </div>
